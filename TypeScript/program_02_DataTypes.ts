...
var arr : Array<string> = ["Utkarsh", " Mayank", "Sandhya", "Sunder"];
...
var arr1 : Array <any> =  [123, "raj", false, {name : "Utkarsh"}];
console.log(arr1);
...
var sn : string | number;  //now the variable "sn" can hold both string and number datatypes.
...
var doubleNum = (num : number) : number => num * 2;
